...
namespace DevIO.App.Extensions
{
    ...
    {
        private readonly IHttpContextAccessor _contextoAccessor; //Se eu quiser acessar o HTTP para capturar o usuário, é so fazer um injeção de dependencia ;

        public ApagaElementoByClaimTagHelper(IHttpContextAccessor contextAccessor)
        {
            _contextoAccessor = contextAccessor;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var temAcesso = CustomAuthorization.ValidarClaimsUsuario(_contextoAccessor.HttpContext, IdentityClaimName, IdentityClaimValue);
    ...
    public class ApagaElementoByActionTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var action = _contextAccessor.HttpContext.GetRouteData().Values["action"].ToString(); //Fazendo assim eu capturo a Action que está tentando acessar
